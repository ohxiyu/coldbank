...
| M4 interoperability | In progress | Origin xpub and BIP84 zpub exports; BC-UR and BBQr paths; deterministic testnet C03 unsigned/signed/optical fixture; first-party PWA constructs/finalizes compatible BBQr PSBTs; source-level Sparrow/BlueWallet/Nunchuk evidence | Exact stable-version device round trips, funded testnet PWA round trip, second tester |
...
- `Coordinator`: TypeScript checking, Cloudflare-compatible production build,
  public fixture derivation/signing finalization, BBQr disorder/duplicate
  handling, provider failover, and ambiguous-broadcast tests.
