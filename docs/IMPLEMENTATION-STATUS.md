...
| M4 interoperability | In progress | Origin xpub and BIP84 zpub exports; BC-UR and BBQr paths; source-level Sparrow/BlueWallet/Nunchuk evidence | Exact stable-version device round trips, checked-in coordinator fixtures, second tester |
...
- `make core-test`: 24 deterministic checks covering BIP39/BIP84 and public exports, redaction, strict PSBT structure/policy, a 512-case mutation smoke corpus, ownership/change, mutation defense, deterministic partial signing, wrong-seed/UTXO rejection, AES-GCM integrity/profile binding, and backup challenges.
